...
export default class Lighthouse extends Phaser.GameObjects.Sprite {
    
    // Define the scale factors for the animation
    private readonly defaultScale: number = 1.0;
    private readonly targetScale: number = 1.2;
